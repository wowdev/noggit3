...
if( WIN32 )
   if( MSVC80 )
       set( COMPILER_PATH "C:/Program\ Files/Microsoft\ Visual\ Studio\ 8/VC/PlatformSDK" )
   endif( MSVC80 )
   if( MSVC90 )
       set( COMPILER_PATH "C:/Program\ Files/Microsoft\ Visual\ Studio\ 9.0/VC" )
   endif( MSVC90 )

   if( MSVC71 )
       set( COMPILER_PATH "C:/Program\ Files/Microsoft\ Visual\ Studio\ .NET\ 2003/Vc7/PlatformSDK" )
   endif( MSVC71 )
   FIND_PATH( GLEW_INCLUDE_DIR GL/glew.h GL/wglew.h
              PATHS c:/glew/include ${COMPILER_PATH}/include )
   SET( GLEW_NAMES glew32 )
   FIND_LIBRARY( GLEW_LIBRARY
                 NAMES ${GLEW_NAMES}
                 PATHS c:/glew/lib ${COMPILER_PATH}/Lib )
else( WIN32 )
