...
: UICloseWindow( video.xres() / 2.0f - winWidth / 2.0f, video.yres() / 2.0f - winHeight / 2.0f, winWidth, winHeight, "Keybindings", true )
{
  addChild( new UIText( 20.0f, 30.0f,
    ...
    "  U - 2D texture editor\n"
    "  H - This help\n"
    "  CTRL + ALT + C - Show/Close CursorSwitcher\n"
    ...
    "  CTRL + X - Toggle detailed window\n"
    "  F9 - Toggle map contour\n"
    "  F - Toggle fog\n"
    "  TAB - toggle UI view\n"
    "  X - View tool settings\n"
    ...
    "  q - Save port commands for current position to ports.txt\n"
  "\n"
  "Adjust:\n"
  ...
  addChild( new UIText( 380.0f, 30.0f,
    ...
    "  CTRL + left mouse + mouse move - change brush size\n"
    ...
    "  PageDown - Set object to ground level\n"
    "  CTRL + C - Copy object to clipboard\n"
    "  CTRL + V - Paste object on mouse position\n"
    "  SHIFT + C - Insert last M2 object\n"
    "  ALT + C - Insert last WMO object\n"
    "  - / + - scale M2\n"
    ...
    "  CTRL + left mouse - Pick texture from chunk\n"
    "\n"
  "Holes:\n"
