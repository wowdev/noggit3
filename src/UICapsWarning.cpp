  ...
  : UIWindow( video.xres() / 2.0f - winWidth / 2.0f, video.yres() / 2.0f - winHeight / 2.0f - ( video.yres() /4), winWidth, winHeight )
{
  ...
  addChild( new UIText( 95.0f, 20.0f, "Caps lock in on!", arial14, eJustifyLeft ) );
  addChild( new UIText( 95.0f, 40.0f, "Turn it off to work with noggit.", arial14, eJustifyLeft ) );
}
