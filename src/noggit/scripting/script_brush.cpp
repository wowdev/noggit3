...
namespace noggit {
  namespace scripting {
    void brush_set_area_id(math::vector_3d& pos, int id, bool adt)
    {
    ...
    void brush_paint_texture(math::vector_3d& pos, float strength, float pressure, float hardness, float radius, char const* texture)
    {
      auto brush = Brush();
    ...
    void brush_change_terrain(math::vector_3d& pos, float change, float radius, float inner_radius, int brush_type)
    {
