...
//  addChild(new UITexture(20.0f, 20.0f, 64.0f, 64.0f, "Interface\\ICONS\\INV_Potion_83.blp"));
  addChild(new UIText(10, 5, "Settings", app.getFritz16(), eJustifyLeft));
    ...
    gamePathField->value("/Applications/World of Warcraft WotLK/");
    ...
    projectPathField->value("/Applications/World of Warcraft WotLK/");
    ...
    farZField->value("1024");
    
    addChild(new UICheckBox(95, 145, "Enable tablet mode"));
    addChild(new UICheckBox(95, 170, "Enable auto-selecting mode"));
    addChild(new UICheckBox(95, 195, "Disable anti-aliasing"));
    addChild(new UICheckBox(95, 220, "Render models with box"));
    addChild(new UICheckBox(95, 245, "Random rotation"));
    addChild(new UICheckBox(95, 270, "Random size"));
    addChild(new UICheckBox(95, 295, "Random tilt"));
}
