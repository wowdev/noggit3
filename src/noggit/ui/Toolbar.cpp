...
namespace noggit
{
  namespace ui
  {
      ...
      , _tool_group(this)
    {
      ...
      add_tool_icon (editing_mode::flatten_blur, tr("Flatten / Blur"),  font_awesome::magic);
      add_tool_icon (editing_mode::paint,        tr("3D Paint"),        font_awesome::paintbrush);
      add_tool_icon (editing_mode::holes,        tr("Holes"),           font_awesome::eraser);
      ...
      add_tool_icon (editing_mode::object,       tr("Object editor"),   font_awesome::arrowsalt);
    }
