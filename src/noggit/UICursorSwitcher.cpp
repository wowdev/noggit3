...
void UICursorSwitcher::set_cursor_type (int value)
{
  Environment::getInstance()->cursorType = value;
}
void UICursorSwitcher::set_red_color (int value)
{
  Environment::getInstance()->cursorColorR = value / 255.0;
}
void UICursorSwitcher::set_green_color (int value)
{
  Environment::getInstance()->cursorColorG = value / 255.0;
}
void UICursorSwitcher::set_blue_color (int value)
{
  Environment::getInstance()->cursorColorB = value / 255.0;
}
void UICursorSwitcher::set_alpha (int value)
{
  Environment::getInstance()->cursorColorA = value / 255.0;
}

UICursorSwitcher::UICursorSwitcher (QWidget* parent)
  : QWidget (parent)
{
